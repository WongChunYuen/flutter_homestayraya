<?php
	...
	$sqlinsert = "INSERT INTO `products_tb`(`user_id`, `product_name`, `product_desc`, `product_price`, `product_address`, `product_state`, `product_local`, `product_lat`, `product_lng`) VALUES ('$userid','$hsname','$hsdesc','$hsprice','$hsaddr','$state','$local','$lat','$lon')";
